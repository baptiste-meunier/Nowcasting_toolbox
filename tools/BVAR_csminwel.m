function [fh,xh,gh,H,itct,fcount,retcodeh] = BVAR_csminwel(fcn,x0,H0,grad,crit,nit,varargin)
%
...
if NumGrad
   if isempty(grad)
      [g badg] = BVAR_numgrad(fcn,x0, varargin{:});
      %ARGLIST
...
while ~done
   ...
   %-------------------------
    ...
    if count ~= 0 && mod(count,10) == 0
        disp(['Running the ',num2str(count),'th iteration '])
    end

   itct=itct+1;
   [f1 x1 fc retcode1] = BVAR_csminit(fcn,x,f,g,badg,H,varargin{:});
   %ARGLIST
   ...
   if retcode1 ~= 1
      if retcode1==2 || retcode1==4
         ...
         if NumGrad
            [g1 badg1] = BVAR_numgrad(fcn, x1,varargin{:});
            %ARGLIST
...
%          save g1 g1 x1 f1 varargin;
      ...
      if wall1 && (length(H) > 1)% 
         ...
         [f2 x2 fc retcode2] = BVAR_csminit(fcn,x,f,g,badg,Hcliff,varargin{:});
         %ARGLIST
         ...
         if  f2 < f
            if retcode2==2 || retcode2==4
               ...
               if NumGrad
                  [g2 badg2] = BVAR_numgrad(fcn, x2,varargin{:});
                  %ARGLIST
...
%                save g2 g2 x2 f2 varargin
            ...
            if wall2
               ...
               if norm(x2-x1) < 1e-13
                  ...
                  [f3 x3 fc retcode3] = BVAR_csminit(fcn,x,f,gcliff,0,eye(nx),varargin{:});
                  %ARGLIST
                  ...
                  if retcode3==2 || retcode3==4
                     ...
                     if NumGrad
                        [g3 badg3] = BVAR_numgrad(fcn, x3,varargin{:});
                        %ARGLIST
...
%                      save g3 g3 x3 f3 varargin;
   ...
   elseif f1 < f - crit && badg1==0
      ...
      if nogh
         if NumGrad
            [gh badgh] = BVAR_numgrad(fcn,xh,varargin{:});
         else
